...
# Generate 30 predicted nodes
future_nodes = scaler_latlong.inverse_transform(predicted_positions[:30])  # Inverse transform to original scale
...
plt.legend()
plt.title("Existing and Predicted Photovoltaic Sites in the U.S.")
plt.show()
